...
1. **Composition over configuration** — Instead of adding props, let consumers
   compose
1. **Lift your state** — State in providers, not trapped in components
1. **Compose your internals** — Subcomponents access context, not props
1. **Explicit variants** — Create ThreadComposer, EditComposer, not Composer
   with isThread
