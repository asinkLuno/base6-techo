...
1. [List Performance](#2-list-performance) — **HIGH**
...
1. [State Architecture](#7-state-architecture) — **MEDIUM**
   - 7.1 [State Must Represent Ground Truth](#71-state-must-represent-ground-truth)
1. [React Compiler](#8-react-compiler) — **MEDIUM**
...
1. [User Interface](#9-user-interface) — **MEDIUM**
...
1. [Design System](#10-design-system) — **MEDIUM**
...
1. **Easier to extend** — Adding opacity, rotation, or other effects just

   requires more interpolations from the same state

1. **Debugging** — Inspecting `pressed = 1` is clearer than `scale = 0.95`

1. **Reusable logic** — The same `pressed` value can drive multiple visual
...
1. [https://reactnative.dev](https://reactnative.dev)
1. [https://docs.swmansion.com/react-native-reanimated](https://docs.swmansion.com/react-native-reanimated)
1. [https://docs.swmansion.com/react-native-gesture-handler](https://docs.swmansion.com/react-native-gesture-handler)
1. [https://docs.expo.dev](https://docs.expo.dev)
1. [https://legendapp.com/open-source/legend-list](https://legendapp.com/open-source/legend-list)
1. [https://github.com/nandorojo/galeria](https://github.com/nandorojo/galeria)
1. [https://zeego.dev](https://zeego.dev)
