...
1. [Patterns and Guidelines](#patterns-and-guidelines)
1. [CSS Animation Recipes](#css-animation-recipes)
1. [View Transitions in Next.js](#view-transitions-in-nextjs)
